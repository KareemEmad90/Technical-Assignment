...
public class RenewVehicleLicensePassedWithFines {
    String chassisNo;
    String eidNUMBER;
    ...
    static Logger log = Logger.getLogger(RenewVehicleLicensePassedWithFines.class.getName());
    ...
    public void renewVehicle(String TextCaseNo, String VehicleWeightFrom,
                             String VehicleWeightTo, String vehicleClassCode, String mortgageStatus, String ExpiredDaysCount, String toRun) throws SQLException, ParseException, ClassNotFoundException, InterruptedException {
...
// ------------------------------------------------Submit Inspection Result-------------------------------------------------------
            ...
            submitInspectionResultResponse = submitInspectionResultAPI.submitInspectionResult(applicationRefNumber, rtaUnifiedNumber, chassisNo, "PASSED");
